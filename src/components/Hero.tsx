...
const Hero = () => {
  ...
  const img3 = useFloatingAnimation({ duration: 5, intensity: 12, delay: 0 });
  const img4 = useFloatingAnimation({ duration: 6, intensity: 14, delay: 0.2 });
  const img5 = useFloatingAnimation({ duration: 5.5, intensity: 13, delay: 0.4 });
  const img6 = useFloatingAnimation({ duration: 6.5, intensity: 11, delay: 0.6 });
  const img7 = useFloatingAnimation({ duration: 5, intensity: 15, delay: 0.8 });
  const img8 = useFloatingAnimation({ duration: 6, intensity: 12, delay: 1.0 });
  const img9 = useFloatingAnimation({ duration: 5.5, intensity: 14, delay: 0.3 });
  const img10 = useFloatingAnimation({ duration: 6, intensity: 13, delay: 0.5 });
  const img11 = useFloatingAnimation({ duration: 5, intensity: 11, delay: 0.7 });
  const img12 = useFloatingAnimation({ duration: 6.5, intensity: 15, delay: 0.9 });
